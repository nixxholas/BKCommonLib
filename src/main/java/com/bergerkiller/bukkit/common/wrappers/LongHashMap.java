...
public class LongHashMap<V> extends BasicWrapper {
     ...
     */
    public int size() {
        return Math.max(((net.minecraft.server.v1_11_R1.LongHashMap) handle).count(), 0);
    }
    ...
    public boolean contains(long key) {
        return ((net.minecraft.server.v1_11_R1.LongHashMap) handle).contains(key);
    }
    ...
    public V get(long key) {
        return (V) ((net.minecraft.server.v1_11_R1.LongHashMap) handle).getEntry(key);
    }
    ...
    public V remove(long key) {
        return (V) ((net.minecraft.server.v1_11_R1.LongHashMap) handle).remove(key);
    }
    ...
    public void put(long key, V value) {
        ((net.minecraft.server.v1_11_R1.LongHashMap) handle).put(key, value);
    }
